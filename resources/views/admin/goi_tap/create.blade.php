...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">
        <i class="bi bi-box-seam me-2"></i>Tạo gói tập mới
    </h1>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.goi-tap.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('ten_goi') is-invalid @enderror" 
                               id="ten_goi" name="ten_goi" value="{{ old('ten_goi') }}" 
                               placeholder="VD: Gói 10 buổi" required>
                        @error('ten_goi')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('so_buoi') is-invalid @enderror" 
                                   id="so_buoi" name="so_buoi" value="{{ old('so_buoi', 10) }}" min="1" required>
                            @error('so_buoi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('gia') is-invalid @enderror" 
                                   id="gia" name="gia" value="{{ old('gia', 0) }}" min="0" required>
                            @error('gia')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="bi bi-check-circle me-2"></i>Lưu gói tập
                    </button>
